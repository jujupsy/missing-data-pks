\section{Abbildungen empirische Wissensstrukturen}
\subsection*{$\eta$-Schätzung: $N = 3700$}
Nachfolgend sind für die empirischen Wissensstrukturen $\mathcal{K}_{err}$, $\mathcal{K}_{geh}$ und $\mathcal{K}_{ges}$ die $\eta$-Parameterschätzungen in Abhängigkeit der wahren Parameterwerte für eine Stichprobengröße von $N = 3700$ abgebildet. Dies geschieht für jedes Modell und jeden Dezimierungsmechanismus.
...
# BLIM_COMP
pdf("plots/blim_comp_bias_emp_eta.pdf", width = 5.5, height = 5.01, pointsize = 12, family = "CM Roman")
...
# BLIM_MAW
pdf("plots/blim_maw_bias_emp_eta.pdf", width = 5.5, height = 5.2, pointsize = 12, family = "CM Roman")
par(mgp = c(1.3, .7, 0), mar = c(3.2, 2.5, .5, 0), oma = c(.5, 1, 2, 0.4))
layout(l.mat[c(rep(1:3, each = 5)) , ])
...
# BLIM_IMBLIM
pdf("plots/imblim_bias_emp_eta.pdf", width = 5.5, height = 5.2, pointsize = 12, family = "CM Roman")
par(mgp = c(1.3, .7, 0), mar = c(3.2, 2.5, .5, 0), oma = c(.5, 1, 2, 0.4))
layout(l.mat[c(rep(1:3, each = 5)) , ])
...
dev.off()
@
\includegraphics[width=.99\textwidth]{plots/imblim_bias_emp_eta}
\end{center}
\caption[$\eta$-Parameterschätzung des IMBLIM für die emp. Wissensstrukturen $(N = 3700)$]{Mittlere $\eta$-Parameterschätzung des IMBLIM in Abhängigkeit des wahren Parameterwertes für jedes der 12 Items der drei empirischen Wissensstrukturen $\mathcal{K}_{err}$, $\mathcal{K}_{geh}$ und $\mathcal{K}_{ges}$ für eine Stichprobengröße von $N = 3700$. Die durchgehende Linie zeigt die 1. Winkelhalbierende und die Standardabweichung ist als Fehlerbalken eingezeichnet.}
\end{figure}
...
# MissBLIM
pdf("plots/missblim_bias_emp_eta.pdf", width = 5.5, height = 5.2, pointsize = 12, family = "CM Roman")
par(mgp = c(1.3, .7, 0), mar = c(3.2, 2.5, .5, 0), oma = c(.5, 1, 2, 0.4))
layout(l.mat[c(rep(1:3, each = 5)) , ])
...
dev.off()
@
\includegraphics[width=.99\textwidth]{plots/missblim_bias_emp_eta}
\end{center}
\caption[$\eta$-Parameterschätzung des MissBLIM für die emp. Wissensstrukturen $(N = 3700)$]{Mittlere $\eta$-Parameterschätzung des MissBLIM in Abhängigkeit des wahren Parameterwertes für jedes der 12 Items der drei empirischen Wissensstrukturen $\mathcal{K}_{err}$, $\mathcal{K}_{geh}$ und $\mathcal{K}_{ges}$ für eine Stichprobengröße von $N = 3700$. Die durchgehende Linie zeigt die 1. Winkelhalbierende und die Standardabweichung ist als Fehlerbalken eingezeichnet.}
\end{figure}